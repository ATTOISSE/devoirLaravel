                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">La vaccination est un moyen sûr et
                                efficace de renforcervotre immunité contre les maladies</h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Protégez-vous et les autres en vous
                                faisant vacciner</h1>
                            <a href="appointment.html"
                                class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Appointment</a>
                            <a href="" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Contact Us</a>
            ...
            <div class="row gx-0">
                ...
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.6s">
                    <div class="bg-secondary d-flex flex-column p-5" style="height: 300px;">
                        ...
                        <p class="text-white">Ipsum erat ipsum dolor clita rebum no rebum dolores labore, ipsum magna at
                            eos et eos amet.</p>
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    ...
                    <div class="section-title mb-4">
                        ...
                        <h1 class="display-5 mb-0"> N'attendez plus, prenez votre santé en main et faites-vous vacciner.
                        </h1>
                    </div>
                    <h4 class="text-body fst-italic mb-4"> La vaccination est un acte responsable qui offre une
                        protection contre les maladies infectieuses, vous permettant ainsi de vivre une vie plus saine
                        et de contribuer à la construction d'une communauté résiliente et protégée.</h4>
                    <p class="mb-4">assurant ainsi notre santé et contribuant à la lutte contre la propagation des
                        maladies</p>
                    <div class="row g-3">
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s"
                            src="pexels-photo-3952224.webp" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-6 py-5">
                    <div class="py-5">
                        <h1 class="display-5 text-white mb-4">"Prenez une décision éclairée pour votre santé et celle de
                            vos proches :</h1>
            ...
            <div class="row g-5 mb-5">
                ...
                <div class="col-lg-7">
                    <div class="section-title mb-5">
                        ...
                        <h1 class="display-5 mb-0"> La vaccination est une mesure proactive qui renforce votre système
                            immunitaire</h1>
                    </div>
                    <div class="row g-5">
                                ...
                                <div class="login-content">
                                    <form action="{{ route('login') }}'" method="post" class="margin-bottom-0">
                                        ...
                                        <div class="login-buttons">
                                            <button type="submit" class="btn btn-success btn-block btn-lg">Sign me
                                                in</button>
                                        </div>
                                    </form>
                                </div>
